...
```{r }
 ...
 plot_alpha_distribution(alpha = sim_data$list_alpha, p=colMeans(sim_data$c0), parameters=parents_info$parameters, parameters2=parameters.logit, pch=16, cex=0.3)
```
# Model parameters
...
Lok at alpha-estimates under projected allele frequencies
```{r }
 parameters.linear<-alpha_distribution(alpha=sim_data$list_alpha, p=colMeans(sim_data$c0), tproj=tproj$m1$tproj)
 parameters.logit<-alpha_distribution(alpha=sim_data$list_alpha, p=colMeans(sim_data$c0), tproj=tproj$m1$tproj, logit=TRUE)

 plot_alpha_distribution(alpha = sim_data$list_alpha, p=colMeans(sim_data$c0), tproj=tproj$m1$tproj, parameters=parameters.linear, parameters2=parameters.logit, pch=16, cex=0.3)
```
