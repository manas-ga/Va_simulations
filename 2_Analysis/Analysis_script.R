...
Set_ID = ifelse(Sys.info()["nodename"]=="SCE-BIO-C06645"|Sys.info()["nodename"]=="sce-bio-c04553", "bc_test_SCE-BIO-C06645_2025-04-22_14-52-17.643965", commandArgs(trailingOnly = TRUE)[1])
