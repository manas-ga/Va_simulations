...
analyse_sim = function(Set_ID,                # The unique ID of the set of simulations that are controlled by a single R script
  ...
  vA_BC = est_Va_bc(pbar1 = sim_data$pbar1,
                    pbar2 = sim_data$pbar2,
                    L = parents_info$L,
                    nR = parents_info$nR,
                    nrep = sim_data$sim_params$n_cages)
