...
d_16 = add_new_va_data(d_new_va, d_16)
...
p_bc_simplified_bc_ia = ggplot(d_16, aes(y = vA_BC_est_ia, x = if(alpha){vA_true_new}else{vA_true}, color = as.factor(sequence_length*r_msp))) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE)  + ylim(0, 0.35) + xlim(0, 0.13) +
  ggtitle("B&C (Approach i-a)") + theme(plot.title = element_text(hjust = 0.5)) 

######################################
### vA_est using B&C Approach ii-a ###
######################################
...
p_bc_simplified_bc_iia = ggplot(d_16, aes(y = vA_BC_est_iia, x = if(alpha){vA_true_new}else{vA_true}, color = as.factor(sequence_length*r_msp))) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE)  + ylim(0, 0.35) + xlim(0, 0.13) +
  ggtitle("B&C (Approach ii-a)") + theme(plot.title = element_text(hjust = 0.5))

#######################################
### vA_est using B&C Approach iii-a ###
#######################################
...
p_bc_simplified_bc_iiia = ggplot(d_16, aes(y = vA_BC_est_iiia, x = if(alpha){vA_true_new}else{vA_true}, color = as.factor(sequence_length*r_msp))) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE)  + ylim(0, 0.35) + xlim(0, 0.13) +
  ggtitle("B&C (Approach iii-a)") + theme(plot.title = element_text(hjust = 0.5))


#####################################
### vA_est using B&C Approach i-b ###
#####################################
...
p_bc_simplified_bc_ib = ggplot(d_16, aes(y = vA_BC_est_ib, x = if(alpha){vA_true_new}else{vA_true}, color = as.factor(sequence_length*r_msp))) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE)  + ylim(0, 0.35) + xlim(0, 0.13) +
  ggtitle("B&C (Approach i-b)") + theme(plot.title = element_text(hjust = 0.5))

######################################
### vA_est using B&C Approach ii-b ###
######################################
...
p_bc_simplified_bc_iib = ggplot(d_16, aes(y = vA_BC_est_iib, x = if(alpha){vA_true_new}else{vA_true}, color = as.factor(sequence_length*r_msp))) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE)  + ylim(0, 0.35) + xlim(0, 0.13) +
  ggtitle("B&C (Approach ii-b)") + theme(plot.title = element_text(hjust = 0.5))

#######################################
### vA_est using B&C Approach iii-b ###
#######################################
...
p_bc_simplified_bc_iiib = ggplot(d_16, aes(y = vA_BC_est_iiib, x = if(alpha){vA_true_new}else{vA_true}, color = as.factor(sequence_length*r_msp))) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE)  + ylim(0, 0.35) + xlim(0, 0.13) +
  ggtitle("B&C (Approach iii-b)") + theme(plot.title = element_text(hjust = 0.5))
...
p_bc_simplified_assumption_G_test = ggplot(d_16, aes(y = assumption_G_test, x = as.factor(sequence_length*r_msp), fill = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_boxplot() + 
  labs(y = "Deviation from Assumption G", x = "Map length in history") + 
...
p_bc_simplified_combined = plot_grid(p_bc_simplified_bc_ia + theme(legend.position = "none"), 
                              ...
                              p_bc_simplified_assumption_G_test + theme(legend.position = "none"), ncol = 2, labels = "AUTO")
p_bc_simplified_combined = plot_grid(p_bc_simplified_combined, legend_16, ncol = 2, rel_widths = c(1, 0.18))
...
ggsave(p_bc_simplified_combined, file = file.path(output_path, "Fig5.jpg"), w = 8, h = 12)
...
#d_17 = add_new_va_data(d_new_va, d_17)
...
p_bc_full_combined = plot_grid(p_bc_full_bc_ia + theme(legend.position = "none"), 
                              ...
                              p_bc_full_assumption_G_test + theme(legend.position = "none"), ncol = 2, labels = "AUTO")
p_bc_full_combined = plot_grid(p_bc_full_combined, legend_17, ncol = 2, rel_widths = c(1, 0.18))
...
ggsave(p_bc_full_combined, file = file.path(output_path, "Fig6.jpg"), w = 8, h = 12)
...
p_ml_diversity_vA_separate = ggplot(d_diversity_ml, aes(y = diversity, x = vA_true_new, shape = locus_type, color = factor(r*sequence_length))) +
  ...
  theme(text = element_text(size = 15)) +
  labs(shape = "", color = "ML (history)", x = TeX(r"(True $V_A$)")) + theme(legend.position = "bottom") +
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999"))
p_ml_diversity_vA_separate

p_ml_issues_2 = plot_grid(p_ml_seg_sites_sel, p_ml_diversity_vA, p_ml_diversity_vA_separate, nrow = 2)
ggsave(p_ml_issues_2, file = file.path(output_path, "ml_issues_2.jpg"), w = 12, h = 10)
