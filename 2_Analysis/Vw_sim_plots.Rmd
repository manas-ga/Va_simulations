...
p_nb_2_ml_exp = ggplot(d_18_ml_exp, aes(y=vA_est, x = vA_true_new, color = factor(sequence_length*r_expt))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_nb_2_nind = ggplot(d_18_nind , aes(y=vA_est, x = vA_true_new, color = factor(n_ind_exp))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_nb_2_ncages = ggplot(d_18_ncages , aes(y=vA_est, x = vA_true_new, color = factor(n_cages))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_nb_2_ngen2 = ggplot(d_18_ngen2 , aes(y=vA_est, x = vA_true_new, color = factor(ngen2-ngen1))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_nb_dom_main = ggplot(d_23, aes(y = vA_est, x = vA_true_new, color = k)) +
  theme_bw() + geom_point() + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"(Degree of dominance $(|\kappa|)$)")) +
  theme(text = element_text(size = 15))+ 
...
p_b_dom_0.5 = ggplot(d_25, aes(y = vA_est, x = vA_true_new, color = k)) +
  theme_bw() + geom_point() + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"(Degree of dominance $(|\kappa|)$)"), title = "0.5 morgan") +
  theme(text = element_text(size = 15)) + 
...
p_b_dom_5 = ggplot(d_32, aes(y = vA_est, x = vA_true_new, color = k)) +
  theme_bw() + geom_point() + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"(Degree of dominance $(|\kappa|)$)"), title = "5 morgans") +
  theme(text = element_text(size = 15))+ 
  scale_color_manual(values = c("#009E73","#0072B2", "#D01C8B")) +
  geom_abline(slope = 1, intercept = 0) +
 theme(legend.position = "bottom") +
...
p_vA_va_0.5 = ggplot(d_25, aes(y = vA_true_new, x = va_true_new, color = k)) +
  theme_bw() + geom_point() + 
  theme(text = element_text(size = 15))+ 
  scale_color_manual(values = c("#009E73","#0072B2", "#D01C8B")) +
 theme(legend.position = "bottom") +
  geom_abline(slope = 1, intercept = 0) +
  geom_smooth(method = "lm", se=FALSE) +
  labs(y = TeX(r"(True additive genetic variance ($V_A$))"), x = TeX(r"(True additive genic variance ($V_a$))"), color = TeX(r"(Degree of dominance $(|\kappa|)$)"), title = "0.5 morgan") + 
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12))

p_vA_va_5 = ggplot(d_32, aes(y = vA_true_new, x = va_true_new, color = k)) +
  theme_bw() + geom_point() + 
  theme(text = element_text(size = 15))+ 
  scale_color_manual(values = c("#009E73","#0072B2", "#D01C8B")) +
 theme(legend.position = "bottom") +
  geom_abline(slope = 1, intercept = 0) +
  geom_smooth(method = "lm", se=FALSE) +
  labs(y = TeX(r"(True additive genetic variance ($V_A$))"), x = TeX(r"(True additive genic variance ($V_a$))"), color = TeX(r"(Degree of dominance $(|\kappa|)$)"), title = "5 morgans") + 
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12))
...
ggsave(p_vA_va_combined, width = 10, height = 6, file = file.path(output_path, "full_dominance_vA_va.jpg"))
...
p_nb_Qcoverage = ggplot(d_nb_Qpoolseq, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  ...
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "", title = "Simplified simulations", subtitle = "(incorporating covariance due to pool-seq in the analyses)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
...
p_nb_coverage_noQ = ggplot(d_nb_poolseq_noQ, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999", "orange")) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "", title = "Simplified simulations", subtitle = "(ignoring covariance due to pool-seq in the analyses)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
 theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12)) 
...
ggsave(plot = p_nb_Qpoolseq_combined, width = 10, height = 5.5, file = file.path(output_path, "poolseq_simplified.jpg"))
...
p_b_Qcoverage = ggplot(d_b_Qpoolseq, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999", "orange")) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "", title = "Full simulations", subtitle = "(incorporating covariance due to pool-seq in the analyses)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
  theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12))

ggsave(plot = p_b_Qcoverage, width = 6, height = 6, file = file.path(output_path, "poolseq_full.jpg"))
...
p_ben_0.033 = ggplot(rbind(d_9_std, d_11, d_14), aes(y = vA_est, x = vA_true_new, color = factor(format(mut_ratio, scientific = FALSE)))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_ml_exp_0.033 = ggplot(d_ml_exp , aes(y=vA_est, x = vA_true_new, color = factor(sequence_length*r_expt))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_scale = ggplot(d_scale , aes(y=vA_est, x = vA_true_new, color = factor(round(2*scale*shape, 2)))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"($E[|\eta|]$)")) + 
  scale_color_manual(values = c("#009E73", "#0072B2","#999999")) + 
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
  theme(plot.title = element_text(hjust = 0.5)) 
...
p_b_0.033_ml = ggplot(d_ml_history , aes(y=vA_est, x = vA_true_new, color = factor(sequence_length*r))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_all.gp = ggplot(d_all.gp, aes(y = vA_est, x = vA_true_new, color = all.gp)) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_Ne = ggplot(d_9_Ne, aes(y = vA_est, x = vA_true_new, color = Ne_exp)) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
p_b_0.045_ml = ggplot(d_N1 , aes(y=vA_est, x = vA_true_new, color = factor(sequence_length*r))) +
  theme_bw() + 
  geom_point() + 
  geom_abline(intercept = 0, slope = 1) + 
...
plot_lost_va_bias = ggplot(d_scale, aes(y = vA_est - vA_true_new,
  ...
  theme_bw() +
  geom_point() +
  labs(y = TeX(r"(Estimate of $V_A$ - True $V_A$)"),x = TeX(r"(Total $V_a$ lost)"), color = TeX(r"($E[|\eta|]$)")) +
  theme(text = element_text(size = 15)) +
  geom_abline(slope = -1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#0072B2", "#999999"))  +
  theme(legend.position = "bottom")
...
plot_finescale_va_lost = ggplot(d_finescale_sel, aes(y = locuswise_va_lost_new, x = abs(list_alpha_new), color = lost_va_type)) +
  theme_bw() +
  geom_point() +
  labs(y = TeX(r"($V_a$ lost at a locus$)"), x = TeX(r"($|\alpha|$)"), color = "Simulation type") +
  theme(text = element_text(size = 15)) +   
  theme(legend.position = "bottom") +
...
p_bc_simplified_us = ggplot(d_16, aes(y = vA_est, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_simplified_bc_ia = ggplot(d_16, aes(y = vA_BC_est_ia, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_simplified_bc_iia = ggplot(d_16, aes(y = vA_BC_est_iia, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_simplified_bc_iiia = ggplot(d_16, aes(y = vA_BC_est_iiia, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_simplified_bc_ib = ggplot(d_16, aes(y = vA_BC_est_ib, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_simplified_bc_iib = ggplot(d_16, aes(y = vA_BC_est_iib, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_simplified_bc_iiib = ggplot(d_16, aes(y = vA_BC_est_iiib, x = vA_true_new, color = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_us = ggplot(d_17, aes(y = vA_est, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_bc_ia = ggplot(d_17, aes(y = vA_BC_est_ia, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_bc_iia = ggplot(d_17, aes(y = vA_BC_est_iia, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_bc_iiia = ggplot(d_17, aes(y = vA_BC_est_iiia, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_bc_ib = ggplot(d_17, aes(y = vA_BC_est_ib, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_bc_iib = ggplot(d_17, aes(y = vA_BC_est_iib, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
...
p_bc_full_bc_iiib = ggplot(d_17, aes(y = vA_BC_est_iiib, x = vA_true_new, color = as.factor(sequence_length*r))) +
  theme_bw() +
  geom_point() +
  geom_abline(intercept = 0, slope = 1) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Map length \nin morgans \n(history)") + 
