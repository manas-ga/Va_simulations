...
if(corrected){
  d_5 = read.csv(file.path(data_path, "combined_data/Set_5_corrected_output.csv"))
}else{
...
ggsave(p_bc_simplified_combined, file = file.path(output_path, "Fig5.jpg"), w = 15, h = 9)
...
ggsave(p_bc_full_combined, file = file.path(output_path, "Fig6.jpg"), w = 15, h = 9)
