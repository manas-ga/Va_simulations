...
ggsave(p_nb_dominance_combined, width = 8, height = 8, file = file.path(output_path, "FigS4.jpg"))
```
...
ggsave(p_b_dominance_combined, width = 8, height = 8, file = file.path(output_path, "FigS5.jpg"))
...
ggsave(plot = p_coverage_combined, width = 8, height = 5, file = file.path(output_path, "Fig7.jpg"))
p_coverage_combined
...
ggsave(plot = p_pool_sites, width = 5, height = 5, file = file.path(output_path, "FigS6.jpg"))
p_pool_sites
...
ggsave(plot = p_OD_combined, width = 8, height = 5, file = file.path(output_path, "FigS7.jpg"))
p_OD_combined
