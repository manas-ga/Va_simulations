...
p_nb_dom_main = ggplot(d_23, aes(y = vA_est, x = vA_true_new, color = k)) +
  theme_bw() + geom_point() + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"(Dominance $(\kappa)$)")) +
  theme(text = element_text(size = 15))+ 
...
p_nb_dom_palpha = ggplot(d_23, aes(y = palpha_est, x = k, fill = k)) +
  ...
  labs(x = "Dominance (|k|)", y = TeX(r"(Estimate of $p_{\alpha} $)"), fill = TeX(r"(Dominance $(\kappa)$)")) +
  theme(text = element_text(size = 15))+ 
...
p_nb_dom_balpha_slope = ggplot(d_23, aes(y = balpha_slope_est, x = k, fill = k)) +
  theme_bw() + geom_boxplot() + 
  labs(x = "Dominance (|k|)", y = TeX(r"(Estimate of $\beta^{(1)}_{\bar{\alpha}}$)"), fill = TeX(r"(Dominance $(\kappa)$)")) +
  theme(text = element_text(size = 15))+ 
  scale_fill_manual(values = c("#009E73", "#0072B2",  "#999999")) +
  geom_abline(slope = 0, intercept = 0, linetype = "dotdash") +
 theme(legend.position = "bottom")
...
p_nb_dom_res_var = ggplot(d_23, aes(y = Residual_var, x = k, fill = k)) +
  theme_bw() + geom_boxplot() + 
  labs(x = "Dominance (|k|)", y = "Residual variance", fill = TeX(r"(Dominance $(\kappa)$)")) +
  theme(text = element_text(size = 15))+ 
  scale_fill_manual(values = c("#009E73", "#0072B2",  "#999999")) +
...
p_b_dom_0.5 = ggplot(d_25, aes(y = vA_est, x = vA_true_new, color = k)) +
  theme_bw() + geom_point() + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"(Dominance $(\kappa)$)"), title = "0.5 morgan") +
  theme(text = element_text(size = 15)) + 
  scale_color_manual(values = c("#009E73","#0072B2", "#D01C8B")) +
  geom_abline(slope = 1, intercept = 0) +
 theme(legend.position = "bottom") +
  geom_smooth(method = "lm", se=FALSE) + 
...
p_vA_va = ggplot(d_25, aes(y = vA_true_new, x = va_true_new, color = k)) +
  theme_bw() + geom_point() + 
  theme(text = element_text(size = 15))+ 
  scale_color_manual(values = c("#009E73","#0072B2", "#D01C8B")) +
 theme(legend.position = "bottom") +
  geom_abline(slope = 1, intercept = 0) +
  geom_smooth(method = "lm", se=FALSE) +
  labs(y = TeX(r"(True additive genetic variance ($V_A$))"), x = TeX(r"(True additive genic variance ($V_a$))"), color = TeX(r"(Dominance $(\kappa)$)"), title = "Full simulations", subtitle = "(with dominance in history phase, 0.5 morgan)") + 
  theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12))

ggsave(p_vA_va, width = 5, height = 5, file = file.path(output_path, "full_dominance_vA_va.jpg"))


### Higher map length in history: 5 morgan ###

d_32 = read.csv(file.path(data_path, "combined_data/Set_32_corrected_output.csv"))
d_32 = add_new_va_data(new_va_data=d_new_va, target_data=d_32, verbose=TRUE)
d_32$k = gsub(".*=", x=d_32$sim, "")

p_b_dom_5 = ggplot(d_32, aes(y = vA_est, x = vA_true_new, color = k)) +
  theme_bw() + geom_point() + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = TeX(r"(Dominance $(\kappa)$)"), title = "5 morgan") +
  theme(text = element_text(size = 15))+ 
  scale_color_manual(values = c("#009E73","#0072B2", "#D01C8B")) +
  geom_abline(slope = 1, intercept = 0) +
 theme(legend.position = "bottom") +
...
ggsave(p_b_dominance_combined, width = 8, height = 5, file = file.path(output_path, "full_dominance.jpg"))
...
ggsave(p_dominance_combined, width = 8, height = 12, file = file.path(output_path, "combined_dominance.jpg"))
...
d_nb_Qpoolseq = read.csv(file.path(data_path, "combined_data/Set_18_corrected_output.csv"))
...
p_nb_Qcoverage = ggplot(d_nb_Qpoolseq, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999", "orange")) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Coverage", title = "Simplified simulations", subtitle = "(~3000 sites, 0.5 morgan)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
...
d_b_Qpoolseq = read.csv(file.path(data_path, "combined_data/Set_9_corrected_output.csv"))
...
d_b_Qpoolseq$Coverage = factor(d_b_Qpoolseq$Coverage, levels = c("Exact", "100x"))


### Make plots ###

p_b_Qcoverage = ggplot(d_b_Qpoolseq, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#999999")) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Coverage", title = "Full simulations", subtitle = "(~65000 sites, 0.5 morgan)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
  theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12))
...
legend_Qpoolseq = get_plot_component(p_nb_Qcoverage + guides(color = guide_legend(nrow = 1)) + theme(legend.position = "bottom"), "guide-box-bottom") 

# Combine without labels

p_Qpoolseq_combined = plot_grid(p_nb_Qcoverage + theme(legend.position = "none"),
                                p_b_Qcoverage + theme(legend.position = "none"),
                                labels = "auto",
                                ncol = 2)

# Add the legend

p_Qpoolseq_combined = plot_grid(p_Qpoolseq_combined,
                                legend_Qpoolseq,
                                nrow = 2, rel_heights = c(1, 0.05))

# Save file

ggsave(plot = p_Qpoolseq_combined, width = 8, height = 5, file = file.path(output_path, "poolseq_withQ.jpg"))
...
# Coverage, read length and overdispersion are varied for poolseq
...
# Only coverage is varied for poolseq

d_nb_coverage_0.01 = read.csv(file.path(data_path, "combined_data/Set_28_corrected_output.csv"))

d_nb_coverage_0.01 = add_new_va_data(new_va_data=d_new_va, target_data=d_nb_coverage_0.01, verbose=TRUE)

d_nb_coverage_0.01$Type = ifelse(grepl("poo", d_nb_coverage_0.01$analysis_stamp),
                sapply(strsplit(d_nb_coverage_0.01$analysis_stamp, "_"), function(x) paste(x[1:11], collapse = "_")),
                "Exact")
...
d_b_coverage_0.1 = read.csv(file.path(data_path, "combined_data/Set_29_corrected_output.csv"))

d_b_coverage_0.1 = add_new_va_data(new_va_data=d_new_va, target_data=d_b_coverage_0.1, verbose=TRUE)

d_b_coverage_0.1$Type = ifelse(grepl("poo", d_b_coverage_0.1$analysis_stamp),
                sapply(strsplit(d_b_coverage_0.1$analysis_stamp, "_"), function(x) paste(x[1:11], collapse = "_")),
                "Exact")
...
#### Restrict only to data where coverage is varied for simplified (ml = 0.5) and full (ml = 0.5) ###
...
d_nb_coverage_0.01$Coverage = ifelse(d_nb_coverage_0.01$Type=="Exact", "Exact",  sapply(strsplit(d_nb_coverage_0.01$analysis_stamp, "_"), function(x) paste(x[8], "x", sep = "")))
d_nb_coverage_0.01$Coverage = factor(d_nb_coverage_0.01$Coverage, levels = c("Exact", "1000x", "500x", "100x"))

d_b_coverage_0.1$Coverage = ifelse(d_b_coverage_0.1$Type=="Exact", "Exact",  sapply(strsplit(d_b_coverage_0.1$analysis_stamp, "_"), function(x) paste(x[8], "x", sep = "")))
d_b_coverage_0.1$Coverage = factor(d_b_coverage_0.1$Coverage, levels = c("Exact", "1000x", "500x", "100x"))
...
p_nb_coverage = ggplot(d_nb_coverage, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
 theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12)) + xlim(0, 0.2) + ylim(0, 0.2)
...
p_b_coverage = ggplot(d_b_coverage, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  ...
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
 theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12)) + xlim(0, 0.1) + ylim(0, 0.175)

p_nb_coverage_low_ml = ggplot(d_nb_coverage_0.01, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999")) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Coverage", title = "Simplified simulations", subtitle = "(~3000 sites, 0.01 morgan)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
 theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12)) + xlim(0, 0.2) + ylim(0, 0.2)

p_b_coverage_low_ml = ggplot(d_b_coverage_0.1, aes(y = vA_est, x = vA_true_new, color = Coverage)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999")) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Coverage", title = "Full simulations", subtitle = "(~65000 sites, 0.1 morgan)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
 theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(hjust = 0.5, size = 12)) + xlim(0, 0.1) + ylim(0, 0.175)
...
p_coverage_combined = plot_grid(p_nb_coverage + theme(legend.position = "none"),
                                p_nb_coverage_low_ml + theme(legend.position = "none"),
                                p_b_coverage + theme(legend.position = "none"),
                                p_b_coverage_low_ml + theme(legend.position = "none"),
                                labels = "auto",
                                ncol = 2)
...
ggsave(plot = p_coverage_combined, width = 8, height = 9, file = file.path(output_path, "poolseq_coverage.jpg"))
p_coverage_combined
...
d_26$Coverage = ifelse(d_26$Type=="Exact", "Exact",  sapply(strsplit(d_26$analysis_stamp, "_"), function(x) paste(x[8], "x", sep = "")))
d_26$Coverage = factor(d_26$Coverage, levels = c("Exact", "1000x", "500x", "100x"))

d_26$Error = d_26$vA_est - d_26$vA_true_new

p_pool_sites = ggplot(d_26, aes(y = Error, x = seg_sites/(r*sequence_length), color = Coverage)) + 
  theme_bw() + geom_point() + geom_abline(slope = 0, intercept = 0) + 
  scale_color_manual(values = c("#009E73", "#D01C8B", "#0072B2", "#999999")) + 
  labs(x = "Density of segregating sites (sites/morgan)", y = TeX(r"(Estimate of $V_A$ - true $V_A$)"), color = "Coverage", title = "Simplified simulations", subtitle = "(0.5 morgan)") +
  theme(text = element_text(size = 15)) + 
...
p_nb_OD = ggplot(d_nb_OD, aes(y = vA_est, x = vA_true_new, color = Type)) +
  ...
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Pool-seq", title = "Simplified simulations", subtitle = "(~3000 sites, 0.5 morgan)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
...
p_b_OD = ggplot(d_b_OD, aes(y = vA_est, x = vA_true_new, color = Type)) +
  theme_bw() + geom_point() + geom_abline(slope = 1, intercept = 0) + 
  scale_color_manual(values = values_OD, labels = labels_OD) + 
  labs(x = TeX(r"(True $V_A$)"), y = TeX(r"(Estimate of $V_A$)"), color = "Pool-seq", title = "Full simulations", subtitle = "(~65000 sites, 0.5 morgan)") +
  theme(text = element_text(size = 15)) +
  geom_smooth(method = "lm", se=FALSE) +
  theme(legend.position = "bottom") + theme(plot.title = element_text(hjust = 0.5), plot.subtitle = element_text(size = 12, hjust = 0.5))
...
##############################################
### Plotting the leading eigenvectors of L ###
##############################################

### Selected the following Set_IDs with true V_A close to 0.05
# "Set_9_bigbird_2024-12-26_03-45-11.636065_2.83054545454545e-07_0.5_2_1000_10_4_0_0"  (scale = 0.033)
# "Set_15_a_bigyin_2025-03-25_14-13-35.560332_8.3979797979798e-08_0.5_2_1000_10_4_0_0"  (scale = 0.1)
# "Set_15_b_bigyin_2025-03-25_20-20-20.587669_1.86545454545455e-07_0.5_2_1000_10_4_0_0" (scale = 0.045)

### The Rdata files containing the necessry data are stored in file.path(data_path/combined_data) and their filenames are:
# Set_9_bigbird_2024-12-26_03-45-11.636065_2.83054545454545e-07_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-26.877413.Rdata
# Set_15_a_bigyin_2025-03-25_14-13-35.560332_8.3979797979798e-08_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-49.384688.Rdata
# Set_15_b_bigyin_2025-03-25_20-20-20.587669_1.86545454545455e-07_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-34.910486.Rdata
    

# Load the Rdata files for each of these simulations

# scale = 0.033
load(file.path(data_path, "combined_data/Set_9_bigbird_2024-12-26_03-45-11.636065_2.83054545454545e-07_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-26.877413.Rdata"))
UL_0.033 = UL_data$UL
DL_0.033 = UL_data$DL
positions_0.033 = UL_data$SNPs

# scale = 0.045
load(file.path(data_path, "combined_data/Set_15_b_bigyin_2025-03-25_20-20-20.587669_1.86545454545455e-07_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-34.910486.Rdata"))
UL_0.045 = UL_data$UL
DL_0.045 = UL_data$DL
positions_0.045 = UL_data$SNPs

# scale = 0.1
load(file.path(data_path, "combined_data/Set_15_a_bigyin_2025-03-25_14-13-35.560332_8.3979797979798e-08_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-49.384688.Rdata"))
UL_0.1 = UL_data$UL
DL_0.1 = UL_data$DL
positions_0.1 = UL_data$SNPs
...
### Selected the following Set_IDs with true V_A close to 0.05
# "Set_9_bigbird_2024-12-26_03-45-11.636065_2.83054545454545e-07_0.5_2_1000_10_4_0_0"  (ml = 0.5)
# "Set_13_bigbird_2025-02-27_01-30-50.592525_2.47672727272727e-07_5_2_1000_10_4_0_0" (ml = 5)
# "Set_13_bigyin_2025-02-28_23-09-50.578271_2.83054545454545e-07_50_2_1000_10_4_0_0" (ml = 50)
# "Set_13_bigyin_2025-03-04_07-58-50.587939_2.78e-07_250_2_1000_10_4_0_0" (ml = 250)


### The Rdata files containing the necessry data are stored in file.path(data_path/combined_data) and their filenames are:
# Set_9_bigbird_2024-12-26_03-45-11.636065_2.83054545454545e-07_0.5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_15-12-26.877413.Rdata
# Set_13_bigbird_2025-02-27_01-30-50.592525_2.47672727272727e-07_5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_16-11-40.048848.Rdata
# Set_13_bigyin_2025-02-28_23-09-50.578271_2.83054545454545e-07_50_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_16-12-21.755107.Rdata
# Set_13_bigyin_2025-03-04_07-58-50.587939_2.78e-07_250_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_16-12-44.87969.Rdata
...
UL_0.5 = UL_data$UL
DL_0.5 = UL_data$DL
positions_0.5 = UL_data$SNPs

# ml = 5
load(file.path(data_path, "combined_data/Set_13_bigbird_2025-02-27_01-30-50.592525_2.47672727272727e-07_5_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_16-11-40.048848.Rdata"))
UL_5 = UL_data$UL
DL_5 = UL_data$DL
positions_5 = UL_data$SNPs

# ml = 50
load(file.path(data_path, "combined_data/Set_13_bigyin_2025-02-28_23-09-50.578271_2.83054545454545e-07_50_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_16-12-21.755107.Rdata"))
UL_50 = UL_data$UL
DL_50 = UL_data$DL
positions_50 = UL_data$SNPs

# ml = 250
load(file.path(data_path, "combined_data/Set_13_bigyin_2025-03-04_07-58-50.587939_2.78e-07_250_2_1000_10_4_0_0_sim_1_UL_positions_ac3-n1_2025-08-19_16-12-44.87969.Rdata"))
UL_250 = UL_data$UL
DL_250 = UL_data$DL
positions_250 = UL_data$SNPs

plot(abs(UL_0.5[,1]) ~ positions_0.5, xlab = "Position", ylab = "Absolute sitewise loadings", main = "0.5 morgan")
plot(abs(UL_5[,1]) ~ positions_5, xlab = "Position", ylab = "Absolute sitewise loadings", main = "5 morgan")
plot(abs(UL_50[,1]) ~ positions_50, xlab = "Position", ylab = "Absolute sitewise loadings", main = "50 morgan")
plot(abs(UL_250[,1]) ~ positions_250, xlab = "Position", ylab = "Absolute sitewise loadings", main = "250 morgan")
...
p_bc_simplified_assumption_G_test = ggplot(d_16, aes(y = assumption_G_test, x = as.factor(sequence_length*r_msp), fill = as.factor(sequence_length*r_msp))) +
  theme_bw() +
  geom_boxplot() + 
  labs(y = "Deviation from Assumption G", x = "Map length in morgan (history)") + 
...
To perform sanity checks on our method, and our implementation of BC's method, we ran (simplified, i.e. no burnin) simulations with nearly-free recombination in the experiment (ml_exp = 5000). The map length in the history (including msprime) was either 0.5, 10, 50, or 100 morgan.
