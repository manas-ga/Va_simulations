...
ggsave(p_nb_dominance_combined, width = 8, height = 8, file = file.path(output_path, "FigS4A.jpg"))
```
...
ggsave(p_b_dominance_combined, width = 8, height = 8, file = file.path(output_path, "FigS4B.jpg"))
...
labels_nb_poolseq = c("Exact" = "Exact",
                     ...
                     "pool_seq_TRUE_read_length_75_coverage_500_V_logmean_0" = expression(R[75]*C[500]*V[0]),
...
values_nb_poolseq = c("Exact" = "#009E73",
                     ...
                     "pool_seq_TRUE_read_length_75_coverage_500_V_logmean_0" = "lightblue",
...
ggsave(plot = p_pool_seq_combined, width = 8, height = 5, file = file.path(output_path, "Fig7.jpg"))
p_pool_seq_combined
...
ggsave(plot = p_pool_sites, width = 5, height = 5, file = file.path(output_path, "FigS5.jpg"))
p_pool_sites
