...
param_matrix[,5] = 10
param_matrix[,6] = 3
bdelta_method = rep("fixed", nsims)

param_matrix = data.frame(param_matrix)

param_matrix[,7] = bdelta_method

write.table(param_matrix, file = "/mnt/c/Users/msamant/Documents/GitHub/Va_simulations/5_History_sim/000_parameter_grid.txt", sep = " ", col.names = FALSE, row.names = FALSE, quote = FALSE)
