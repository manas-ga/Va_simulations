...
Paths to various scripts that are used for running the simulations and extracting information from SLiM outputs. `base_path` specifies the path to all the scripts (except "Vw.Rmd") - typically the "5_History_sim" folder in "Va_simulations". `Vw_path` specifies the path to "Vw.Rmd", and `file_storage_path` is where the ?XXX files are stored? `slim_path` specifies the path to the folder of SLiM output.
...
if(Sys.info()["nodename"]=="vera.bio.ed.ac.uk"){
  ...
  base_path = "/data/home/msamant/Manas/Va_simulations/Github/Va_simulations/5_History_sim" 
  Vw_path = "/data/home/msamant/Manas/Va_simulations/Github/Va_simulations/6_Code_Test/Vw.Rmd"  
...
if(Sys.info()["nodename"]=="SCE-BIO-C06645"){
  ...
  if(Sys.info()["sysname"]=="Linux"){   ## Local Wsl
    ...
    base_path = "/mnt/c/Users/msamant/Documents/GitHub/Va_simulations/5_History_sim"
    Vw_path = "/mnt/c/Users/msamant/Documents/GitHub/Va_simulations/6_Code_test/Vw.Rmd" 
    file_storage_path = base_path
    
  }else{                                ## Local windows
    
    base_path = "C:/Users/msamant/Documents/GitHub/Va_simulations/5_History_sim" 
...
if(Sys.info()["nodename"]=="sce-bio-c04553"){  
  ...
  Vw_path = "~/Work/Va_simulations/6_Code_test/Vw.Rmd"
  file_storage_path = base_path
