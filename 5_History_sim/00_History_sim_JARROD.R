...
mu_list = seq(7.0e-08, 7.0e-07, length = nsims)  # If mu is to be varied in order to vary true Vw # (1.5-6.0 e-06 works splendidly)
...
pdelta_method = "estimate" # "optim" or "manual" or "fixed". If "this is "no_analysis", the estimate of Vw is not calculated, but the rest of the code still runs.
