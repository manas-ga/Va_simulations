...
nsims = 2                              # Number of simulations (change scale in each simulation)
...
mu_list = seq(8.5e-08, 7.56e-07, length = nsims)  # If mu is to be varied in order to vary true Vw # (1.5-6.0 e-06 works splendidly)
