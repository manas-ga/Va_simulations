...
n_cages = 2                           # The number of replicate cages in the experiment
start_gen = 1                          # 
end_gen = 2                            # How many generations should the SLiM simulation run for while simulating the history (burnin)
output_freq = 500                      # The frequency with which SLiM outputs are to be generated for the analysis of history 
...
for (sim in 1:nsims){
    ...
    for (cage in (1:n_cages)){
      ...
      message(paste("Extracting mutations and storing allele frequencies in cage ", cage, "...", sep = ""))
