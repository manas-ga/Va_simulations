...
mu_list = seq(1.5e-07, 1.5e-06, length = nsims)  # If mu is to be varied in order to vary true Vw # (1.5-6.0 e-06 works splendidly)
...
if(pdelta_method=="fixed"){
  pdelta = -2 # Can be specified to any value
}
