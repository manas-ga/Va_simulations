...
3. Vector of positions of mutations (list_pos)
4. pbar1 
5. pbar2
...
extract_slim_data = function(Set_ID,                # The unique ID of the set of simulations that are controlled by a single R script
                             ...
                             slim_output_path,      # The directory where the SLiM outputs (for parents and experimental replicates) are stored
  ...
  # Read genomes
    ...
    list_pos = mutations_0$Position # Vector of positions of mutations in the parents
  ...
  return(list(c0=c_ind/2, list_alpha=list_alpha, list_pos=list_pos, pbar1=pbar1, pbar2=pbar2))
