...
analyse_parents = function(c0,  
  ...
  if(LDdelta){
    ...
    TrV<-sum(diag(L%*%diag(diag(L)^pdelta_emp)))*sigma2delta_emp
  ...
  return(list(L=L, nR=nR, seg_sites=seg_sites, seg_sites_neu=seg_sites_neu, seg_sites_ben=seg_sites_ben, mean_diversity=mean_diversity, va_true=va_true, vA_true=vA_true, vA_alpha_emp=vA_alpha_emp, pdelta_emp=pdelta_emp, bdelta_intercept_emp=bdelta_intercept_emp, bdelta_slope_emp=bdelta_slope_emp))
