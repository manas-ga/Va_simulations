...
ts = tskit.load(f"{slim_output_path}/sim{sys.argv[3]}_output_history.trees") # sys.argv[3] is the simulation in progress
...
ts.dump(f"{slim_output_path}/sim{sys.argv[3]}_output_history_with_neutral.trees")
