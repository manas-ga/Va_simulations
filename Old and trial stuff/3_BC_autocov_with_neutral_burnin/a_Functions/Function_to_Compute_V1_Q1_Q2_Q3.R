...
# Calculates Va, Q1, Q2, and Q3, summed site diversity, no. of segregating loci, no. of selected loci, variance in alphas, mean of alphas
...
# Need the full list pf alphas for Q1 and Q3
...
# Create a data frame of Frequency and list_alpha_full
...
q1 = cov(2*frame_q1[,1]*(1-frame_q1[,1]), frame_q1[,2]*frame_q1[,2])
...
# Create a data frame of q3_a and q3_b
...
Diversity = sum(2*Frequency*(1-Frequency))

##############################
### Variance in alphas #######
##############################

var_alpha = var(list_alpha)

##############################
###### Mean of alphas ########
##############################

mean_alpha = mean(list_alpha)
...
return(c(va, q1, q2, q3, Diversity, n_sites_ret, length(list_selected), var_alpha, mean_alpha))
