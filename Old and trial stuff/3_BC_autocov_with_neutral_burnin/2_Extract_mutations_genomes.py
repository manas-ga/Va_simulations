...
wd = "C:/Academics/Post-doc/Va_simulations/3_With_neutral_burnin_msprime/"
...
# Extract just the mutations for the reimaining generations


#for gen in range(start_gen + 1, end_gen + 1, output_freq):
#    file = f"Output_{gen}.txt"
#    extract_mutations(slim_output_path = f"{wd}b_Interim_files/SLiM_Outputs/{file}", mutations_path = f"{wd}b_Interim_files/Mutations/mutations_{gen}.txt")
