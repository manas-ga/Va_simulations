...
Job_ID = "TEST3"                 # Job ID will be prefixed to Set_IDs so that output files can be more easily parsed
...
end_gen = 5000                            # How many generations should the SLiM simulation run for while simulating the history (burnin) (for sims without burnin this has to be 2)
...
total_sites = if(end_gen==2){3000}else{75000}
