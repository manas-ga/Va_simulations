...
Job_ID = "poo_seq_test"                    # Job ID will be prefixed to Set_IDs so that output files can be more easily parsed
...
# Dominance
use_dominance = 1
k = 0.1 # Dominance coefficient; heterozygote phenotype = (1 + k)eta/2 where eta = 2*s; d = k*eta
