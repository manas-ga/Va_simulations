...
Job_ID = "Set_2"                 # Job ID will be prefixed to Set_IDs so that output files can be more easily parsed
...
total_sites = if(end_gen==2){3000}else{30000}
...
scale_list = if(end_gen==2){seq(0.033, 0.033, length = nsims)}else{seq(0.1, 0.1, length = nsims)}  # Vector of Scale of the gamma DFE
