...
# source("C:/Users/msamant/Documents/GitHub/Va_simulations/1_Simulations/00_History_sim_JARROD.R") ## Local windows

# source("/mnt/c/Users/msamant/Documents/GitHub/Va_simulations/1_Simulations/00_History_sim_JARROD.R") ## Local Wsl

# source("/data/home/msamant/Manas/Va_simulations/Github/Va_simulations/1_Simulations/00_History_sim_JARROD.R")  ## ON VERA

# source("/ceph/users/marun/Va_simulations/1_Simulations/00_History_sim_JARROD.R")  ## ON QMASTER
...
if(Sys.info()["nodename"]=="vera.bio.ed.ac.uk"){
  ...
  analysis_path = "/data/home/msamant/Manas/Va_simulations/Github/Va_simulations/2_Analysis"  ### Jarrod's functions and other code is stored here
...
if(Sys.info()["nodename"]=="SCE-BIO-C06645"){
  ...
  if(Sys.info()["sysname"]=="Linux"){
    ...
    analysis_path = "/mnt/c/Users/msamant/Documents/GitHub/Va_simulations/2_Analysis" ### Jarrod's functions and other code is stored here
    file_storage_path = base_path
    
  }else{
    
    base_path = "C:/Users/msamant/Documents/GitHub/Va_simulations/1_Simulations" ## Local windows
    analysis_path = "C:/Users/msamant/Documents/GitHub/Va_simulations/2_Analysis" ### Jarrod's functions and other code is stored here
    file_storage_path = base_path
  }
...
mutations_path = paste(file_storage_path, "/b_Interim_files/Mutations", sep = "")                                     ## Path for text file containing mutations generated by the python script  
c_matrix_path = paste(file_storage_path, "/b_Interim_files/C_matrices", sep = "")                                     ## .csv file storing c matrix generated by the python script
output_path = paste(file_storage_path, "/c_Output", sep = "")
...
#system(paste("rm -rf", paste(file_storage_path, "/b_Interim_files/*", sep = ""))) # Remove the contents of this directory

system(paste("mkdir -p", paste(file_storage_path, "/b_Interim_files/C_matrices", sep = ""))) 
system(paste("mkdir -p", paste(file_storage_path, "/b_Interim_files/Mutations", sep = "")))
...
vA_alpha_emp = rep(NA, nsims) # vA_estimated using L; A, DL and X (obtained from Vw_model()),  and empirical alpha properties (obtained using alpha_distribution())
...
for (sim in 1:nsims){
  ...
  if(simulate){
      ...
      if(record == TRUE&analyse==FALSE){
        ...
        write.table(dat[,1:19], file = paste(output_path, "/", Set_ID, "_Data.csv", sep = ""),col.names = FALSE, row.names = FALSE, sep = ",")
      }
