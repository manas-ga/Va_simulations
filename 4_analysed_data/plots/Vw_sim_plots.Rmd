...
all.gp_labs = c(TeX(r"(Weighted sum of ${\bf L}^{'}_{0}$ and ${\bf L}^{''}_{0}$)"), TeX(r"($\bf L_0$)"))
...
```{r}
p_b_0.033_combined = plot_grid(p_ml_exp_0.033, p_b_0.033_ml, p_ben_0.033, p_scale,  ncol = 2, labels = "AUTO")
