...
# Just check by plotting, if things are copied okay 

plot_lost_va_1 = ggplot(d_scale, aes(y = fract_va_lost, x = factor(round(shape*scale, digits = 4)))) +
  theme_bw() +
  geom_boxplot() +
  labs(y = TeX(r"(Fraction of the total $V_a(0)$ lost)"), x = TeX(r"(Non-neutral $\mu_{\alpha}$)")) +
  theme(text = element_text(size = 15)) 
...
p_balpha1_lost_va = ggplot(d_scale, aes(x = fract_va_lost, y = balpha_slope_est, color = factor(scale*shape))) +
  theme_bw() +
  geom_point() +
  labs(x = TeX(r"(Fraction of the total $V_a(0)$ lost)"), y = TeX(r"(Estimate of $\beta^{(1)}_{\bar{\alpha}}$)"), color = TeX(r"(Non-neutral $\mu_{\alpha}$)")) +
  theme(text = element_text(size = 15))  + 
  scale_color_manual(values = c("#0072B2", "#999999", "#009E73")) 

# balpha intercept

p_balpha0_lost_va = ggplot(d_scale, aes(x = fract_va_lost, y = balpha_intercept_est, color = factor(scale*shape))) +
  theme_bw() +
  geom_point() +
  labs(x = TeX(r"(Fraction of the total $V_a(0)$ lost)"), y = TeX(r"(Estimate of $\beta^{(0)}_{\bar{\alpha}}$)"), color = TeX(r"(Non-neutral $\mu_{\alpha}$)")) +
  theme(text = element_text(size = 15))  + 
  scale_color_manual(values = c("#0072B2", "#999999", "#009E73")) 

#palpha

p_palpha_lost_va = ggplot(d_scale, aes(x = fract_va_lost, y = palpha_est, color = factor(scale*shape))) +
  theme_bw() +
  geom_point() +
  labs(x = TeX(r"(Fraction of the total $V_a(0)$ lost)"), y = TeX(r"(Estimate of $p_{\alpha} $)"), color = TeX(r"(Non-neutral $\mu_{\alpha}$)")) +
  theme(text = element_text(size = 15))  + 
  scale_color_manual(values = c("#0072B2", "#999999", "#009E73")) 


p_test = ggplot(d_scale, aes(x = (vA_true), y = palpha_est, color = factor(scale*shape))) +
  theme_bw() +
  geom_point() +
  theme(text = element_text(size = 15))  + 
  scale_color_manual(values = c("#0072B2", "#999999", "#009E73")) 
