...
# Calculates the c matrix for individuals of the population 
# Draws a random sample of individuals, and trims the c matrix accordingly
# Calculates the L matrix the sample
...
c_ind_population = c_genome[seq(1, 2*n_individuals, 2),] + c_genome[seq(2, 2*n_individuals, 2),]

# Draw a random sample of individuals and trim to c matrix to contain only the sampled individuals

sample_size = 50

c_ind = c_ind_population[sample(1:n_individuals, sample_size, replace = F),]
