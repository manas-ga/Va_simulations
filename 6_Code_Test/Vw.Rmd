...
fit.model<-function(pdelta, nsnps, UL, DL, L, ngen2, ngen1, nind, projp, pbar1, pbar2, nrep, nR, LLonly=FALSE){
...
Vw_model<-function(C0,          # parental genotypes (rows individuals, columns loci, coded as 0, 1/2 or 1) 
  ...
  if(is.null(pdelta)){
    ...
    pdelta<-optim(0, fit.model, nsnps=nsnps, UL=UL, DL=DL, L=L, ngen2=ngen2, ngen1=ngen1, nind=nind, projp=projp, pbar1=pbar1, pbar2=pbar2, nrep=nrep, LLonly=TRUE, nR=nR, control = list(fnscale=-1))$par

  }

  output<-fit.model(pdelta=pdelta, nsnps=nsnps, UL=UL, DL=DL, L=L, ngen2=ngen2, ngen1=ngen1, nind=nind, projp=projp, pbar1=pbar1, pbar2=pbar2, nrep=nrep, LLonly=FALSE, nR=nR)
