...
#rmarkdown::render("/Users/jhadfiel/Work/Va_simulations/6_Code_Test/Vw.Rmd")
```
...
Vw_model<-function(C0,          # parental genotypes (rows individuals, columns loci, coded as 0, 1/2 or 1) 
  ...
  dimnames(SC) <- list(1:retain,1:retain)  # used for full-form matrices
...
```{r run_simulations, results="hide"} 
